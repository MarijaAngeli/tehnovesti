        ...
        <main class="main">
                ...
                <div class="pagination-arrow">
                	@if($prev)   
	                    <a href="{{ route('post.single',['slug'=>$prev->slug])}}" class="btn-next-wrap">
	                        <div class="btn-content">
	                            <div class="btn-content-title">Sledeca</div>
	                            <p class="btn-content-subtitle">{{str_limit(strip_tags($prev->title), 50)}}</p>
	                        </div>
	                        <svg class="btn-next">
                	...
                	@if($next)
	                    <a href="{{ route('post.single',['slug'=>$next->slug]) }}" class="btn-prev-wrap">
	                        ...
	                        <div class="btn-content">
	                            <div class="btn-content-title">Predhodna</div>
	                            <p class="btn-content-subtitle">{{str_limit(strip_tags($next->title),50)}}</p>
	                        </div>
	                    </a>
	                @endif    
                </div>
            ...
            <div class="col-lg-12">
                <aside aria-label="sidebar" class="sidebar sidebar-right">
                    <div  class="widget w-tags">
                        <div class="heading text-center">
                            <h4 class="heading-title">All Post Tags</h4>
                            <div class="heading-line">
                                <span class="short-line"></span>
                                <span class="long-line"></span>
                            </div>
